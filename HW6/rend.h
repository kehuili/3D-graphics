...
public:
	...
	// HW6
	int GzSetOffset(float x, float y, float w);
private:
	// HW1
	...
	// HW3
	void copyMatrix(GzMatrix m0, GzMatrix m1);
	void multiply(GzMatrix m0, GzMatrix m1, GzMatrix res);
	float dot(GzCoord v0, GzCoord v1);
	int vectorMultiply(GzMatrix m, GzCoord c, GzCoord res, int flag);
	// HW4
	void copyColor(GzColor c0, GzColor c1);
	void shadeColor(GzCoord norm, GzColor color);
	void copyCoord(GzCoord c0, GzCoord c1);
	void minusCoord(GzCoord c0, GzCoord c1, GzCoord res);
	void plusCoord(GzCoord c0, GzCoord c1, GzCoord res);
	void normalize(GzCoord c);
	// HW5
	void copytextureIndex(GzTextureIndex tex0, GzTextureIndex tex1);
};
#endif